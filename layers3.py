...
def feature_extractor(inputs,
    ...
    filled_full_adjacency_x = \
        full_adjacency*K.repeat_elements(K.expand_dims(distance[:,:,0],2),n_nodes, axis=2)
    filled_full_adjacency_y = \
        full_adjacency*K.repeat_elements(K.expand_dims(distance[:,:,1],2),n_nodes, axis=2)
    filled_full_adjacency_z = \
        full_adjacency*K.repeat_elements(K.expand_dims(distance[:,:,2],2),n_nodes, axis=2)
    #filled_full_adjacency = full_adjacency*K.repeat_elements(distance,n_nodes)
